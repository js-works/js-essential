...
"js-utility" is a small JavaScript library providing a bunch of useful classes
...
### Current features of "js-utility" 
...
"js-utility" will support all ECMAScript 5 JavaScript engines, in particular all
modern browsers (IE >= 10) and server-side Node.

### Further information

For more information please refer to the "js-utility" API documentation.<br/>
